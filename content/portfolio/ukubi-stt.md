...
still loads, still transcribes, and returns entirely correct text about thirty
times slower, with nothing in the logs that reads as an error. So the binary
